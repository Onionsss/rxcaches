...
public class VolleyUtil {
     ...
     */
    public void VolleyGet(String url,final VolleyGetListener volleyListener){
        ...
        MyApplicaiton.mVolleyQueue.add(sr);
    }
     ...
     * @param map
     */
    public void VolleyPost(String url,final Map<String,String> map, final VolleyGetListener volleyListener){
